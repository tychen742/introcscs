...
To further explain how constructors work, take a look at the following code::
   ...
   internal class Program
   {
      static void Main(string[] args)
      {
         ...
         check.PrintResult();   // output "Username {userName} is valid!"
      }
   }
...
.. note:: 
   ...
   the more current syntax and discussion of properties such as in `Using Properties 
   <https://learn.microsoft.com/en-us/dotnet/csharp/programming-guide/classes-and-structs/using-properties#the-get-accessor>_`. 
