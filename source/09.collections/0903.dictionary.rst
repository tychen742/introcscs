...
restriction on the key type: it should be **immutable**. This has to do with the 
implementation referenced in :ref:`dictionary-efficiency`.
...
as a sequence of pairs {key, value}. Again, this is *special* to csharprepl.  
Here is a longer csharprepl sequence, broken up with our comments:
