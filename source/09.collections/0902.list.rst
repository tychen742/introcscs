...
classes, *generics*. There is a namespace for the generics 
...
To create a string list variable, an example looks like::
...
Similarly, The type for an ``int`` list is ::

    List<int>

and you can follow similar fashion to add elements to and loop through the list. 
