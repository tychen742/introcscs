...
Interfaces [#interfaces-w3school]_ is another way of achieving abstraction in C#. An interface is a completely 
...
an interface definition that does not have any method implementation (body, ``{}``)::
