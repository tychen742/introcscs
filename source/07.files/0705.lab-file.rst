...
a.  Download :download:`../../examples/introcs/sum_file/sum_file.cs`, copy the method CalcSum 
    and the logic in the Main to your project Program.cs of the chapter to make sure it works. 
    Write a new method with the header below. Use it in ``Main``, in place of the ``if`` 
