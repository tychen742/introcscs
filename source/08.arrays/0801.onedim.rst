...
Write a method ``Adder`` that calculates and prints the sum of 
command line parameters taken from user input:: 
...
Going down to the bin/Debug directory from the command line, you will find the executables,
