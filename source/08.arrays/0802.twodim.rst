...
(2D), 3-dimension (3D) as shown below [#multi-d-arrays]_. 
 ...
 .. image:: ../images/multi-d-arrays
   :width: 400


Since arrays use indices to access the elements, find a value, you must specify the 
position within the array. In a 1d array you specify just the index, in a 2d array, 
you specify row and column, and in a 3d array you specify plane, row, and column. 
You can have higher dimension arrays, they are just difficult to imagine.

Rectangular Arrays (Two Dimensional)
--------------------------------------

You have learned about one dimensional arrays. The data in arrays
...
The following csharprepl sequence illustrates the syntax needed::
   ...
   > table.Length;
   12
   > Console.WriteLine(table.GetLength(0));    //Array.GetLength(Int32) method
   3
