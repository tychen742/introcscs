...
.. note:: 
   ...
   Common sorting algorithms are included in this section but, for the purpose of this 
   course, only the essential ideas will be discussed and demonstrated.
...
IT professional should at least know at a basic level. It also turns out to be a great
...
experimentally. [#algorithm-books]_
...
.. [#algorithm-books] For a full theoretical treatment, we recommend the outstanding textbook by Niklaus Wirth: Algorithms + Data Structures = Programs, Prentice Hall, 1976, who invented the Pascal language. Also adapted are some examples from Thomas W. Christopher's animated sorting algorithms `page <http://tools-of-computing.com/tc/CS/Sorts/SortAlgorithms.htm>`_.