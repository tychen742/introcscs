...
As the number get extremely larger or smaller or complex, or when different 
types of data such as text are introduced, the designers of the the programming 
language needed to decide how much memory to reserve for different types of values 
so that computer memories can be effectively used, hence different data types 
were designed. 
