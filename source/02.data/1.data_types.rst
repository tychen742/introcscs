...
Different types are designed to meet the needs of different use scenarios. For example, 
for financial unit, the decimal type is a better choice because it is designed for 
the purpose of holding a larger range of digits with higher precision. 
