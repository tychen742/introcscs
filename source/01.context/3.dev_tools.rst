...
For the purpose of this book, you may use PowerShell and use the Bash commands with a slightly differnt interface.  
...
funtionalities. For example, oen of the first the default location after logging in is the user's home directory, which is specifed 
as /home/USER_NAME.
...
* ``exit`` to exit out of the terminal app.
 ...
 Some special characters are commonly used for specifying path:
...
Integrated development environmnet (IDE) applications play a critical role in software development workflow and 
...
.. [#f] StackOverflow Annual Developer Survey 2023. https://survey.stackoverflow.co/2023/#most-popular-technologies-new-collab-tools-prof