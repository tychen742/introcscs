...
.. code-block:: bash
   ...
   PS C:\Users\username> wsl                              ### start the Windows Subsystem for Linux
   username@COMPUTER:/mnt/c/Users/username$ mkdir test    ### create the test directory
   username@COMPUTER:/mnt/c/Users/username$ cd test       ### change into the test directory
   username@COMPUTER:/mnt/c/Users/username/test$ touch test.txt ### create an empty file
   username@COMPUTER:/mnt/c/Users/username/test$ ls       ### list storage to see the file
   test.txt
   username@COMPUTER:/mnt/c/Users/username/test$ cd ..    ### change to the upper directory
   username@COMPUTER:/mnt/c/Users/username$

.. figure:: ../images/shell_test_windows.jpg
    :scale: 25%

    Creating a test directory and a test file in Windows using wsl. 
