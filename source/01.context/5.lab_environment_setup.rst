...
#.  Create a C# Hello World app project (hello1)
    ...
    #. In a newly opened VS Code window (File --> New Window if you are using 
       ...
       view and choose "Console App" from the Command Palette. Alternatively, 
       Cmd-Shift-P, Win-Shift-P, or View --> Command Palette to bring up Command Palette 
       and then type .NET: New Project, then select "Console App" as your project template. 
