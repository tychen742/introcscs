...
- Note that the course policy is that you should not use generative AI (GAI)
  without authorization. If you are suspected to have used GAI to generate answers 
