...
the C# while loop::
   ...
   > while (n < 5)               // conditional expression in the while loop header
      {                                                   
         ...
         n++;                    // iterator (iteration expression)/update                                                                                      
      }                                                                                                                 
   01234
   > 
...
Both code have ``initializer``, ``conditional expression``, and ``iteration expression`` 
...
Just like in ``for`` statement :ref:`for-statement`, manipulating the header sections will 
change the behavior of the loop.  
